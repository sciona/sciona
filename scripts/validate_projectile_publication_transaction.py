...
import scripts.promote_projectile_revision as publisher
...
if __name__=='__main__':
    ...
    (ROOT/'docs/reviews/projectile_revision_publication_transaction.json').write_text(json.dumps(report,indent=2)+'\n')
