...
def population_inputs(population, time_start):
    ...
    report=dict(unique_raw_queries=count,synthetic_repetitions_per_query=repetitions,
    ...
    return table,report,queries,options,dict(feature_columns=order,numeric_fills=numeric,categorical_fills=categories)
