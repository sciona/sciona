"""Rollback-only corruption checks for the original period/frequency revision."""
import json
...
from scripts.stage_period_frequency_original_revision import ROOT,ARTIFACT,ORIGINAL,EXECUTION,sha,require
...
if __name__=='__main__':
    report=validate()
    (ROOT/'docs/reviews/period_frequency_revision_database_gates.json').write_text(json.dumps(report,indent=2)+'\n')
