"""Exact parent database checks usable inside rollback corruption transactions."""
import hashlib
import importlib
import inspect
import json
...
def check_parent_database(db,root):
    ...
    return graph,dict(version_id=str(record['version_id']),graph_sha256=record['content_hash'])
