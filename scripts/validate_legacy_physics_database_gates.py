...
from scripts.stage_legacy_physics_revisions import ROOT,sha,require,RUNNER
...
if __name__=='__main__':
    report=validate()
    (ROOT/'docs/reviews/legacy_physics_database_gates.json').write_text(json.dumps(report,indent=2)+'\n')
