...
import scripts.promote_series_revision as publisher
...
if __name__=='__main__':
    ...
    (ROOT/'docs/reviews/series_revision_publication_transaction.json').write_text(json.dumps(report,indent=2)+'\n')
