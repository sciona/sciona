...
import scripts.promote_nasa_first_corrected_intake as publisher
...
if __name__=='__main__':
    report=validate()
    (ROOT/'docs/reviews/competition_nasa_first_corrected_publication_transaction_gates.json').write_text(json.dumps(report,indent=2)+'\n')
