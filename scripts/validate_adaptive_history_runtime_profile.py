...
def main():
    ...
    try:
        import psycopg
        from scripts.validate_adaptive_history_catalog import validate
    ...
    report = dict(format='adaptive-history-runtime-profile.v1', passed=True, approved=False,
    ...
    (ROOT / 'docs/reviews/adaptive_history_runtime_profile.json').write_text(json.dumps(report, indent=2) + '\n')
