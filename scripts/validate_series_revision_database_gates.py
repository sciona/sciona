"""Rollback-only corruption checks for the original series-resistance revision."""
import json
...
from scripts.stage_series_original_revision import ROOT,ARTIFACT,ORIGINAL,EXECUTION,sha,require
...
if __name__=='__main__':
    report=validate()
    (ROOT/'docs/reviews/series_revision_database_gates.json').write_text(json.dumps(report,indent=2)+'\n')
