...
import scripts.promote_legacy_physics_revisions as publisher


def snapshot():
    items=json.loads((ROOT/'docs/reviews/legacy_physics_revision_import.json').read_text())['graphs'];ids=[r['artifact_id'] for r in items];result={}
...
if __name__=='__main__':
    ...
    (ROOT/'docs/reviews/legacy_physics_publication_transaction.json').write_text(json.dumps(report,indent=2)+'\n')
