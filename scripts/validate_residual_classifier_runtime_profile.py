...
def main():
    ...
    try:
        import psycopg
        from scripts.validate_residual_classifier_catalog import validate
    ...
    report = dict(format='residual-classifier-runtime-profile.v1', passed=True, approved=False,
    ...
    (ROOT / 'docs/reviews/residual_classifier_runtime_profile.json').write_text(json.dumps(report, indent=2) + '\n')
