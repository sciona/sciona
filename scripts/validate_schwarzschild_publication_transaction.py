...
import scripts.promote_schwarzschild_revision as publisher
...
if __name__=='__main__':
    ...
    (ROOT/'docs/reviews/schwarzschild_revision_publication_transaction.json').write_text(json.dumps(report,indent=2)+'\n')
